 ...
 * Permite cambiar entre ambas manteniendo posición y orientación.
 */
export function createCameraManager() {
    ...
    // --- Cámara perspectiva ---
    const perspCam = new THREE.PerspectiveCamera(50, aspect, 0.1, 200);
    perspCam.position.set(0, 6, 14);
